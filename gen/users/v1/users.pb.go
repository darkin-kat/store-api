...
const file_users_v1_users_proto_rawDesc = "" +
	"\n" +
	"\x14users/v1/users.proto\x12\busers.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cgoogle/api/annotations.proto\"\x82\x02\n" +
	"\x04User\x12\x0e\n" +
	...
	"\x04role\x18\x05 \x01(\x0e2\x0e.users.v1.RoleR\x04role\x129\n" +
	"\n" +
